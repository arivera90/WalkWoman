...
class Woman(pygame.sprite.Sprite):
    step_sound_filename = ["WalkWoman","assets", "sound", "walking_grass.wav"]

    def __init__(self,position):
        pygame.mixer.set_num_channels(1)  
        self.step_sound = pygame.mixer.Sound(os.path.join(*Woman.step_sound_filename))
        image_path = resources.path(Config.get_instance().data["woman_sprite_pakage"],Config.get_instance().data["woman_sprite_filename"])
